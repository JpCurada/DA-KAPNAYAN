...
st.title('S-KAPNAYAN: A Web App for Stoichiometry Problems')
...
with st.expander("Check these examples!"):
    st.write("""
...
try:
    ...
    with feature_t1:
        ...
        st.write("""##### Required: """)
        determine_substance_mol = st.selectbox("Find amount the mole of this substance:", tuple(reaction_substance_list), key="mole_to_mole_required")
    ...
    with feature_t5:
        ...
        st.caption('Units of number of particles can be represented as atoms, molecules, and particles')
