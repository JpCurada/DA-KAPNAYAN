...
st.set_page_config(
    ...
    menu_items={
        ...
        'About': "##### DA-KAPNAYAN aims to make learning solving Stoichiometry problems with Dimensional Analysis easy!"
    }
)
...
acs_stable_elements_mass_dict = {'H':1.008, 'Li':6.94, 'Na':22.99, 'K':39.10,'Rb':85.47, 'Cs':132.9, 
                          ...
                          'La' :138.9, 'Ce':140.1, 'Pr':140.9, 'Nd':144.2, 'Sm':150.4, 'Eu':152.0, 'Gd':157.2, 'Tb':158.9, 'Dy':162.5, 'Ho':164.9, 'Er':167.3, 'Tm':168.9, 'Yb':173, 'Lu':175,
                          'Th':232, 'Pa':231, 'U':238, 
